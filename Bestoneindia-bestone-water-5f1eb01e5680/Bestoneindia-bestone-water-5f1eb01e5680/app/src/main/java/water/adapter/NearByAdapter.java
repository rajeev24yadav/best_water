...
import com.bestone.water.databinding.LayoutNearByListBinding;
...
public class NearByAdapter extends RecyclerView.Adapter<NearByAdapter.TopItemViewHolder> {
    ...
    public TopItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutNearByListBinding binding =
                DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.layout_near_by_list, parent, false);
...
//            }
        ...
        public void setBinding(LayoutNearByListBinding layoutTopItemsListBinding) {
