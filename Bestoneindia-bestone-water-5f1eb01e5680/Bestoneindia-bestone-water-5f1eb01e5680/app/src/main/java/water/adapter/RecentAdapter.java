...
public class RecentAdapter extends RecyclerView.Adapter<RecentAdapter.TopItemViewHolder>{
    ...
    public TopItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutRecentItemListBinding binding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.layout_recent_item_list, parent, false);
